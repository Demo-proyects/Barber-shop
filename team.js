const barbers = [
        {
            ...
            desc:    "Over 10 years mastering classic tapers and straight-razor shaves. Specializes in vintage cuts with a modern edge.",
            yrs:     10, clients: "2.1k", rating: "4.9"
        },
        {
            name:    "Jake P.",
            theme:   "Gold-2",
            img:     "img/barbero-2.jpg",
            desc:    "Precision fade artist with 7 years' experience. Known for beard sculpting and skin-fade mastery.",
            yrs:     7, clients: "1.8k", rating: "4.8"
        },
        {
            name:    "Enrique S.",
            theme:   "Gold-3",
            img:     "img/barbero-3.jpg",
            desc:    "A legend in the chair with 12 years of cuts. Signature textured crops and old-school hot-towel finishes.",
            yrs:     12, clients: "3.4k", rating: "5.0"
        },
        {
            name:    "Barbara L.",
            theme:   "Gold-4",
            img:     "img/barbero-4.jpg",
            desc:    "9 years specializing in curly & textured hair. Brings precision styling and unmatched attention to detail.",
            yrs:     9, clients: "2.6k", rating: "4.9"
        }
    ];
